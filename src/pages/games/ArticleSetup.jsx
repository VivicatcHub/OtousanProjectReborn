...
const PRESETS = [
  {
    emoji: "😩",
    titleKey: "articleSetup.presetClassicTitle",
    descKey: "articleSetup.presetClassicDesc",
    color: "bg-sun text-foreground",
    params: { dir: "known-learn", image: 1 },
  },
  {
    emoji: "🧠",
    titleKey: "articleSetup.presetNoImageTitle",
    descKey: "articleSetup.presetNoImageDesc",
    color: "bg-grape",
    params: { dir: "known-learn", image: 0 },
  },
  {
    emoji: "♾️",
    titleKey: "articleSetup.presetEndlessTitle",
    descKey: "articleSetup.presetEndlessDesc",
    color: "bg-grass",
...
export default function ArticleSetup() {
  ...
  const play = (params) =>
    navigate(`/games/article/play?${new URLSearchParams(params)}`);

  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-black">
          {translate("articleSetup.title")}
        </h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <PresetCard
          ...
          onClick={() => navigate("/games/article/custom")}
        />
      </div>
    </div>
  );
